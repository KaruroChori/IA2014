...
public class Rilevatore2 {
     ...
     */
    public Rilevatore2(Document document) {
        /*
     ...
     * valore detto scala_base che definisce la grandezza della finestra di
     * ricerca, un valore scala_inc che è l'incremento dato ad ogni iterazione
     * del ciclo fino al valore massimo scala_max calcolato considerando il
     * valore minimo fra larghezza e altezza dell'immagine divise
     * rispettivamente per il valore x e y di size (che altro non è che la
     * descrizione di una finestra quadrata 24x24).
     *
     * @param grayIntImg
     * @param sqrGrayIntImg
     * @param scala_base
